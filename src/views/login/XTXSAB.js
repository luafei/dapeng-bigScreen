...
PicComInterface.ConvertSvg2Png = function (inData, cb, ctx) {
	var ret = OGetPic.ConvertSvg2Png(inData);
	return $myOKRtnFunc(ret, cb, ctx);
}


WebsocketInterface.ConvertSvg2Png = function (inData, cb, ctx) {
	var paramArray = [inData];
	WebsocketApp.callMethod('ConvertSvg2Png', cb, ctx, "string", paramArray);
}
...
export { init, WebsocketInterface, SetOnUsbKeyChangeCallBack }
