<template>
  <div class="entrance">
    <div class="title-time">
        ...
        <Businessoneecharts :values="values"  :labels="labels"></Businessoneecharts>>
    </div>
  </div>
</template>
...
import Businessoneecharts from './echarts/Businessoneecharts'
import {getqueryQZ} from '@/api/gov'
import {getServiceTer} from '@/api/citynew'
